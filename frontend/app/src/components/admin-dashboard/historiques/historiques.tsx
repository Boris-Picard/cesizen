...
import { historiqueColumns } from "./column";
import { useGetHistoriques } from "@/hooks/admin/historiques/useGetHistoriques";

export function HistoriquesComponents() {
    const { historiques, loading } = useGetHistoriques();
                        ...
                        >
                            ...
                            {loading ? (
                                ...
                                <DataTable
                                    ...
                                    data={historiques.map(item => ({ ...item, id: item.histo_id }))}
                                />
                            )}
                        </motion.div>
                    </main>
