            ...
            <div className="space-y-8">
              ...
              >
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    <h3 className="text-sm font-medium text-leather-800">Besoin d'aide ?</h3>
                    <div className="mt-1 text-sm text-leather-600">
                      <p>
                        Si vous ne recevez pas l'e-mail dans les prochaines minutes, vérifiez votre dossier de spam ou{" "}
                        <Link
                          to="/contact"
